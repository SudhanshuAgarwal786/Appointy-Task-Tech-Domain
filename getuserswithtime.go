...
func CheckUserwithTime(CheckStartTime string, CheckEndTime string) []User {
...
func GetUserwithTime(response http.ResponseWriter, request *http.Request) {
	...
	meetingswithtime := CheckUserwithTime(CheckStartTime, CheckEndTime)
